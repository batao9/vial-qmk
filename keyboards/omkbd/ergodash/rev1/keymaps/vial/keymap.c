...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC ,                        ALT_SPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP  , KC_SLSH,
    KC_LCTL, KC_LGUI, LT2_DEL, KC_LALT,          LT2_LG2, KC_SPC ,KC_LSFT,        KC_RSFT,CTL_SPC, LT2_LG1,          KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
